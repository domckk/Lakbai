...
export function IconDestinations({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconQuests({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconCheckpoints({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconPassports({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconRewards({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconAnalytics({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
...
export function IconSignOut({ className, size }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
